...
const Hero = () => {
    return (
        <Box as="section" overflow="hidden" h='90vh' display='flex' flexDir='column' justifyContent='center' alignContent='center'>
            <Box
                maxW={{
                    base: 'xl',
                    md: '7xl',
                ...
                >
                    ...
                    >
                        <Heading as="h1" size="2xl" mt="12" fontWeight="black">
                            ...
                            </chakra.span>{' '} Dashboard
                        </Heading>
                        <Text color={mode('gray.600', 'gray.400')} mt="6" fontSize="xl">
                            Optimalisasi prioritas mitigasi multibencana menggunakan data penginderaan jauh (remote sensing) multisumber berbasis Machine Learning
                        </Text>
                        <Button 
